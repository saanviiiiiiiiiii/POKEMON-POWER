...
root=Tk()
root.title("Saanvi's endless pokemon card game")
...
player1 = Label(root, text = "Player 1", bg = "light blue", fg = "black")
player1.place(relx = 0.1, rely = 0.3 , anchor =  CENTER)

player2 = Label(root, text = "Player 2", bg = "light blue", fg = "black")
player2.place(relx = 0.9, rely = 0.3 , anchor =  CENTER)

player_1_score_label = Label(root , bg = "lavender", fg = "black")
player_1_score_label.place(relx = 0.1, rely = 0.4 , anchor =  CENTER)

player_2_score_label = Label(root , bg = "lavender", fg = "black")
